            ...
            <div className="row">
              <div className="col-md-6">
                <div className="card" style={{marginTop:'20px',marginBottom:'15px', width:'700px', padding:'20px',backgroundColor: 'ButtonShadow',border:'3px solid #02084b'}}>
                  ...
                  {project.status === 'pending' ? <Link to='/Certificate' className="popular-foods__button" style={{ marginLeft: '40%', marginTop:'-70px', marginRight:'-50px '}}>Get Certificate</Link> : null}
                </div>
